...
$query="select * from tenantpaid";
$data=mysqli_query($conn,$query);
while($result = mysqli_fetch_assoc($data)) {
  // assuming $result['t_id'] contains the tenant ID you want to link to
  $url = "viewtenant.php?id=" . $result['id'];
  echo "<tr><td><a href='$url'>".$result['id']."</a></td><td>".$result['firstname']."</td></tr>";
}
echo "</table>";
?>
</div>
